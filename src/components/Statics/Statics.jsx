...
const Statics = () => {
  const assignments = [
    ...
    { name: "assignment4", value: 59 },
    { name: "assignment5", value: 58 },
    { name: "assignment6", value: 56 },
    { name: "assignment7", value: 60 },
    { name: "assignment7", value: 30 },
  ];
  ...
  return (
    <div className="d-flex flex-column align-items-center justify-content-center border my-5 container shadow rounded-5 border-5">
      <h4 className="p-4 text-danger">My Assignments Marks from 1 to 8:</h4>
